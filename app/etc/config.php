...
return [
    'modules' => [
        ...
        'Codazon_Slideshow' => 1,
        'Codazon_ProductLabel' => 0,
        'Codazon_Utility' => 1,
        'Durovin_Payment' => 1,
        'Ebizmarts_MailChimp' => 1,
        'Etatvasoft_ProductLabel' => 1,
        'Fetchify_Fetchify' => 1,
        ...
        'Plumrocket_AmpApi' => 1,
        'Plumrocket_AmpAdminUi' => 1,
        'Plumrocket_Amp' => 1,
        'Plumrocket_AmpCatalog' => 1,
        'Plumrocket_AmpBundle' => 1,
        'Plumrocket_AmpCatalogSearch' => 1,
        'Plumrocket_AmpCheckout' => 1,
        'Plumrocket_AmpCms' => 1,
        'Plumrocket_AmpComponent' => 1,
        'Plumrocket_AmpConfigurableProduct' => 1,
        'Plumrocket_AmpCookie' => 1,
        'Plumrocket_AmpCustomer' => 1,
        'Plumrocket_AmpDownloadable' => 1,
        'Plumrocket_AmpFrontendUi' => 1,
        'Plumrocket_AmpGiftCard' => 1,
        'Plumrocket_AmpGroupedProduct' => 1,
        'Plumrocket_AmpIntegrations' => 1,
        'Plumrocket_AmpLayeredNavigation' => 1,
        'Plumrocket_AmpMsrp' => 1,
        'Plumrocket_AmpNewsletter' => 1,
        'Plumrocket_AmpPageCache' => 1,
        'Plumrocket_AmpReCaptcha' => 1,
        'Plumrocket_AmpReview' => 1,
        'Plumrocket_AmpRichSnippets' => 1,
        'Plumrocket_AmpSearch' => 1,
        'Plumrocket_AmpSwatches' => 1,
        'Plumrocket_AmpTheme' => 1,
        'Plumrocket_AmpThemeOne' => 1,
        'Plumrocket_AmpThirdPartiesCompatibility' => 1,
        'Plumrocket_AmpWebP' => 1,
        'Plumrocket_AmpWidget' => 1,
        'Plumrocket_AmpWishlist' => 1,
        'Plumrocket_Base' => 1,
        'Plumrocket_ExtendedAdminUi' => 1,
        'Product_Blogsearch' => 1,
        'Product_Dropdown' => 1,
        'SY_Attachments' => 1,
        'SY_GoToTopButton' => 1,
