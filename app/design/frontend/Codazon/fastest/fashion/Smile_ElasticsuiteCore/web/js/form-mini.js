...
define([
    ...
    $.widget('smileEs.quickSearch', $.mage.quickSearch, {
        ...
        /**
         * Fetch blog post of requested string and append results in search results.
         *
         * @param {String} value.
         *
         * @returns {void}
        ...
        _fetchBlogPosts : function(params){
            $.ajax({
                ...
                success: function(data, status, xhr) {
                    ...
                    var newHtml = ''
                    newHtml += '<dl role="listbox" class="autocomplete-list custom_blog_search_wrapper">';
                    ...
                    if(!parseInt(postcount) <= 0 ){
                        if($('.custom_blog_search_wrapper').length > 0){
                            $('.custom_blog_search_wrapper').remove();
                        }
