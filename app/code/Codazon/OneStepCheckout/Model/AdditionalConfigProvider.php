...
class AdditionalConfigProvider implements ConfigProviderInterface
{
    ...
    public function __construct(
        ...
        \Codazon\OneStepCheckout\Helper\Config $opcConfig
    ) {
        $this->_scopeConfiguration = $scopeConfiguration;
        $this->_opcConfig = $opcConfig;
    }
    ...
    public function getConfig()
    {
        ...
        $oscEnabled = $this->_opcConfig->isEnabledOneStep();
        $displayConfig['show_comment_block'] = ($enabled) ? true : false;
        $displayConfig['is_osc_enabled'] = ($oscEnabled) ? true : false;
