<?php
namespace Etatvasoft\ProductLabel\Setup;
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'group' => 'General',
                'source' => 'Etatvasoft\ProductLabel\Model\Config\Source\LabelOptions',
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'group' => 'General',
                'source' => 'Etatvasoft\ProductLabel\Model\Config\Source\ShapeOptions',
                'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_GLOBAL,
                'visible' => true,
                'used_for_promo_rules' => true,
                'required' => false,
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'input' => 'image',
                'backend' => 'Etatvasoft\ProductLabel\Model\Product\Attribute\Backend\File',
                'frontend' => '',
                'class' => '',
                'source' => '',
                'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_GLOBAL,
        ...
        foreach ($attributeSetCollection as $attributeSet) {
            $eavSetup->addAttributeToSet("catalog_product", $attributeSet->getAttributeSetName(), "General", "product_label_image");
        }
    }
}
